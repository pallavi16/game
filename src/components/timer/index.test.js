...
describe('timer', () => {
  ...
  it('should correctly compute number of minutes and carry over seconds', () => {
    console.log('Correctly computes minutes and seconds');
