...
//Various board functions to describe board actions
//openCellAction: When the cell is opened on the board
//isBoardComplete: Checks to see if more cells can be opened
//Flag: toggleFlagAction and removeFlagAction
